...
function RateFormInner({ appMenuButton }: { appMenuButton: React.ReactNode }) {
...
export function RateForm({ appMenuButton }: { appMenuButton: React.ReactNode }) {
  return (
    <Suspense>
      <RateFormInner appMenuButton={appMenuButton} />
    </Suspense>
  );
}
